...
# Parsing + Configuration Script – WS558 - Rev. A

This **Parsing + Configuration** script is designed for the **WS558** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – WS558 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **WS558** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
